...
export default function ScrollingRules() {
  ...
  useEffect(() => {
    ...
    slides.forEach((slide) => {
      ...
      // 3D entrance — card tilts as you scroll into it
      gsap.to(content, {
        rotationZ: randomZ,
        scale: 0.7,
        rotationX: 40,
  ...
  return (
    <section id="rules" className={styles.scrollingRules} ref={sectionRef}>
      <div className={styles.slides}>
        {rules.map((rule, i) => (
          <div key={rule.num} className={styles.slide}>
            <div className={styles.contentWrapper}>
              <div className={`${styles.content} ${styles[`theme${(i % 3) + 1}`]}`}>
                ...
                <div className={styles.bottom}>
                  ...
                  <div className={styles.bottomRight}>
                    <p className={styles.ruleNum}>({rule.num})</p>
                    <Image
                      src={rule.image}
                      alt=""
